...
{
    internal sealed class CommandUpdater : NoteUpdater
    {
        const string UPDATER_NAME = "CommandUpdater";
        ...
        void Awake()
        {
            Majdata<CommandUpdater>.Instance = this;
        }
        protected override void OnDestroy()
        {
            Majdata<CommandUpdater>.Free();
            base.OnDestroy();
        }
